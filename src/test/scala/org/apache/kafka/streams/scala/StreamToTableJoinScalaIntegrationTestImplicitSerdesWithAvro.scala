...
import org.apache.kafka.server.scala.{KafkaLocalServer, MessageListener, MessageSender, RecordProcessorTrait}
...
object StreamToTableJoinScalaIntegrationTestImplicitSerdesWithAvro
  ...
  test("should count clicks per region") { server =>
    ...
    val streamsConfiguration: Properties = {
      ...
      p.put(StreamsConfig.APPLICATION_ID_CONFIG, s"stream-table-join-scala-integration-test-implicit-serdes-${Random.nextInt(100)}")
